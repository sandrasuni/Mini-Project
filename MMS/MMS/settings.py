...
SECRET_KEY = 'django-insecure-1ybxq(6=km7=)+b+uq*t#3-=68t1^!aq=1loum5cnd&&lh8@zj'
...
INSTALLED_APPS = [
    ...
    'mess_amount.apps.MessAmountConfig',
    'extraorder_master.apps.ExtraorderMasterConfig',
    'extraorder_sub.apps.ExtraorderSubConfig',
